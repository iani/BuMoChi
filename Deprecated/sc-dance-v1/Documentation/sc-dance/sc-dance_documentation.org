...
** Loading and Starting the Demo Project in Godot
   ...
   The `sc-dance` library is designed to work with a companion Godot project. A recommended demo project is [[https://github.com/iani/boy_and_birds][boy_and_birds]]. Alternatively copy the xarts folder from the downloaded package of the live coding deliverable.
