// 金 11  7 2025 05:36
// Parse messags received from Bunraku.
// Hold dictionaries that translate symbol addresses of joints
// to index addresses in a Bunraku message or in a control bus
// holding bunraku data.
...
BunrakuParser {
	...
	var <msgDict; // translate from joint name to index in bunraku message
