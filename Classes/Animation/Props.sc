// 月 14  7 2025 16:45
// Send Bunraku props as additional message.

// Properties are an additional protocol that is sent in a separate OSC message.
// The message format is:

// ['/bunraku/props/', r, g, b, type, posx, posy, posz, qx, qy, qz, qw]

// For the meanings of the above refer to this json format definition from the Bunraku website:
