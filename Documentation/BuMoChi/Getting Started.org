...
If the software is not installed yet, follow [[file:Installation.md][Installation]]. To set up the system to receive animation data and run animations on Godot, see: [[file:HelpByTopic/Setup.md][Setup]].
...
:END:
This preparation omits OSCGroups so that the first tests remain local and easy to diagnose. For the complete pipeline procedure, see [[file:HelpByTopic/Setup.md][Setup]].
