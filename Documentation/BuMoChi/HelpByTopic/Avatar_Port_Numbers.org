...
The fuller =motions= and =figures= session format is specified in [[file:SessionDataObjectsAndTerminology.org][Session Data Objects and Terminology]] but is not yet implemented by =BmcSession=.
