...
:CUSTOM_ID: overview
:END:
This file contains background information about the component applications of this system and their use. For procedural installation instructions, see [[../Installation.md][Installation]].
...
:PROPERTIES:
:CUSTOM_ID: what-this-repository-includes
:END:
...
:PROPERTIES:
:CUSTOM_ID: what-users-install-separately
:END:
** 1. SuperCollider
:PROPERTIES:
:CUSTOM_ID: 1-supercollider
:END:
...
:PROPERTIES:
:CUSTOM_ID: 5-oscgroups--required-only-for-networked-tests
:END:
...
:PROPERTIES:
:CUSTOM_ID: recommended-first-verification
:END:
Open a terminal at the BuMoChi repository root and follow [[file:Bunraku%20pipeline%20tests.md][Bunraku pipeline tests]] in order:
