...
:PROPERTIES:
:CUSTOM_ID: check-the-active-bmc-port-configuration
:END:
...
#+ATTR_LATEX: :align @{}r p{0.15\textwidth} p{0.15\textwidth} p{0.18\textwidth} p{0.38\textwidth}@{}
...
2. [@2] For OSCGroups collaboration only, obtain the =OscGroupServer= address and a unique username from the session organiser. Confirm whether the session uses the default group =bumochi= and password =bmc123= or overrides them.
...
For screenshots and detailed configuration instructions, see [[file:PortNumberSetup.md#1-xr-animator-vmc-output-port][XR-Animator VMC output port]] and [[file:HelperApplications/BunrakuOSCEncoder.md#configure-xr-animator][Configure XR-Animator]].
...
For installation, options, and diagnostic instructions, see [[file:HelperApplications/BunrakuOSCEncoder.md#how-to-start-bunrakuoscencoder][How to start BunrakuOSCEncoder]] and [[file:HelperApplications/BunrakuOSCEncoder.md#test-and-diagnose][Test and diagnose BunrakuOSCEncoder]].
...
For argument definitions, installation, and checks, see [[file:HelperApplications/OSCGroupsClient.md#how-to-start-oscgroupclient][How to start OscGroupClient]], [[file:HelperApplications/OSCGroupsClient.md#command-line-arguments][OscGroupClient command-line arguments]], and [[file:PortNumberSetup.md#2-oscgroupclient-port][OSCGroupClient port]].
...
For details, see [[file:PortNumberSetup.md#3-supercollider-port-listening-to-oscgroupclient][SuperCollider port listening to OSCGroupClient]], [[file:PortNumberSetup.md#default-forwarding-pipeline-of-bumochi-after-fresh-library-compile][Default forwarding pipeline of BuMoChi]], and [[../UserGuide.md#system-control][Bmc system control]].
...
For installation, options, and diagnostics, see [[file:HelperApplications/BunrakuOSCDecoder.md#how-to-start-bunrakuoscdecoder][How to start BunrakuOSCDecoder]] and [[file:HelperApplications/BunrakuOSCDecoder.md#test-and-diagnose][Test and diagnose BunrakuOSCDecoder]].
...
For detailed inspection and configuration instructions, see [[file:PortNumberSetup.md#4-godot-avatar-specific-listening-port][Godot avatar-specific listening port]].
...
See [[file:Multi-Avatar%20project%20port%20number%20setting%20in%20godot%20-%20NOTES.md#set-the-vmc-port-numbers-for-mother-and-ishidomaru][Multi-Avatar project port number setting in Godot]] for the explicit-receiver arrangement.
