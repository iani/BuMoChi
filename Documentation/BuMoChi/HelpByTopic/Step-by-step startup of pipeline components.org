This detailed step-by-step guide is superseded by [[file:Setup.md#quick-start-one-command-pipeline-launcher][the simplified setup procedure]]. The instructions are provided here for testing and troubleshooting if needed.
