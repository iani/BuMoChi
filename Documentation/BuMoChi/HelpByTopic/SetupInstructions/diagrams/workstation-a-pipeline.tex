...
\begin{tikzpicture}[node distance=16mm and 20mm]
  ...
  \node[box,fill=scyellow,right=35mm of enc] (bmc) {SuperCollider / Bmc\\input: UDP \texttt{57130}\\routes \texttt{PerformerA}\\fan-out: \texttt{39538}, \texttt{22244}};
  \node[box,fill=bunrakuorange,right=of bmc] (dec) {BunrakuOSCDecoder\\input: UDP \texttt{39538}\\reads embedded target port};

  \node[smallbox,fill=networkviolet,below=22mm of bmc] (client) {OscGroupClient A\\localTx: \texttt{22244}\\localRx: \texttt{39538}\\unique username A};
  ...
  \draw[flow] (client.east) -| node[label,pos=.72,below]{remote \texttt{PerformerB} routed v2\\UDP \texttt{39538}} (dec.south);
