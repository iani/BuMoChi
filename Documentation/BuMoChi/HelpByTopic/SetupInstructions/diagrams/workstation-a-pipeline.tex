...
\begin{tikzpicture}[node distance=16mm and 20mm]
  ...
  \node[smallbox,fill=networkviolet,below=22mm of bmc] (client) {OscGroupClient A\\localTx: \texttt{22244}\\localRx: \texttt{57130}\\unique username A};
  ...
  \draw[flow] (client.north) -- node[label,midway,right]{remote \texttt{PerformerB} route-free v1\\UDP \texttt{57130}} (bmc.south);
  ...
  \node[font=\sffamily\bfseries,above=12mm of bmc] {Workstation A -- distributed sources, local synthesis and rendering};
