...
:CUSTOM_ID: purpose
:END:
This document explains how motion-capture sources become completed avatar motion on two collaborating BuMoChi workstations. It describes signal meaning and ownership rather than application startup commands. For the complete launch procedure, see [[file:MultiUserSetup.md][Multi User Setup]].

* Core principle: distributed sources, local synthesis
:PROPERTIES:
:CUSTOM_ID: core-principle-distributed-sources-local-synthesis
:END:
...
:PROPERTIES:
:CUSTOM_ID: complete-two-workstation-signal-flow
:END:
#+begin_src mermaid
flowchart LR
...
:PROPERTIES:
:CUSTOM_ID: what-happens-to-one-source-frame
:END:
...
:PROPERTIES:
:CUSTOM_ID: source-identity-figure-identity-and-avatar-identity
:END:
...
:PROPERTIES:
:CUSTOM_ID: settings-that-must-agree
:END:
...
:PROPERTIES:
:CUSTOM_ID: timing-and-visual-agreement
:END:
...
:PROPERTIES:
:CUSTOM_ID: paths-that-must-not-be-created
:END:
...
* Related guides
:PROPERTIES:
:CUSTOM_ID: related-guides
:END:
- [[file:MultiUserSetup.md][Multi User Setup]]
