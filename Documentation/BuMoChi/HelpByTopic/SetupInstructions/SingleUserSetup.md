...
Bmc in SuperCollider
    ...
    -> OSCGroups forwarding disabled for this setup
...
Use this for simplicity. SuperCollider must embed the correct destination port in every protocol-version-2 frame, either from the active scene definition or from manually configured Bmc avatars.
