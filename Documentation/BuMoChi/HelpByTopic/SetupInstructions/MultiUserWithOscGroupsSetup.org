...
local XR-Animator
    -> VMC 127.0.0.1:39537
local [[file:../HelperApplications/BunrakuOSCEncoder.md][BunrakuOSCEncoder]]
...
one local [[file:../HelperApplications/BunrakuOSCDecoder.md][BunrakuOSCDecoder]]
...
|-------+---------------------------------+---------------------------------------|
| 39537 | local [[file:../HelperApplications/BunrakuOSCEncoder.md][BunrakuOSCEncoder]] | local XR-Animator |
...
- [[file:../OSCGroupsUseAndConfiguration.md][OscGroupClient Use and Configuration]]
...
- [[file:../PortNumberSpecification.md][Port Number Specification]]
