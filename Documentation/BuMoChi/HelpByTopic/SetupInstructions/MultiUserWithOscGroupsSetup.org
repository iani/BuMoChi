...
#+CAPTION: Workstation A: local XR-Animator path, OSCGroups exchange, SuperCollider routing, decoding, and Godot destinations.
#+ATTR_HTML: :width 100%
...
#+CAPTION: Workstation B: local XR-Animator path, OSCGroups exchange, SuperCollider routing, decoding, and Godot destinations.
#+ATTR_HTML: :width 100%
#+ATTR_LATEX: :width 1.0\linewidth
