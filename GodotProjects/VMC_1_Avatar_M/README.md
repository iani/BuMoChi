...
This Seed 2 B project replaces the original demo characters with the Ishidomaru VRM avatar and presents Ishidomaru alone, without the floor grid or direction ring, so the avatar appears suspended in space.
