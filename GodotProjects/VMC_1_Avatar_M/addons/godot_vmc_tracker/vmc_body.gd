...
## Common VRM 0.x/1.x expression names transmitted by applications such as
## XR-Animator. Keys are normalized to lower case by VMCSource. Each alias can
## drive several ARKit-style channels used by XRFaceTracker.
const FACE_BLEND_ALIASES := {
	"blink": [FaceBlend.EYE_BLINK_LEFT, FaceBlend.EYE_BLINK_RIGHT],
	"blink_l": [FaceBlend.EYE_BLINK_LEFT],
	"blinkleft": [FaceBlend.EYE_BLINK_LEFT],
	"blink_r": [FaceBlend.EYE_BLINK_RIGHT],
	"blinkright": [FaceBlend.EYE_BLINK_RIGHT],
	"a": [FaceBlend.JAW_OPEN],
	"aa": [FaceBlend.JAW_OPEN],
	"i": [FaceBlend.MOUTH_STRETCH_LEFT, FaceBlend.MOUTH_STRETCH_RIGHT],
	"ih": [FaceBlend.MOUTH_STRETCH_LEFT, FaceBlend.MOUTH_STRETCH_RIGHT],
	"e": [FaceBlend.MOUTH_STRETCH_LEFT, FaceBlend.MOUTH_STRETCH_RIGHT],
	"ee": [FaceBlend.MOUTH_STRETCH_LEFT, FaceBlend.MOUTH_STRETCH_RIGHT],
	"u": [FaceBlend.MOUTH_PUCKER],
	"ou": [FaceBlend.MOUTH_PUCKER],
	"o": [FaceBlend.MOUTH_FUNNEL],
	"oh": [FaceBlend.MOUTH_FUNNEL],
	"joy": [FaceBlend.MOUTH_SMILE_LEFT, FaceBlend.MOUTH_SMILE_RIGHT],
	"happy": [FaceBlend.MOUTH_SMILE_LEFT, FaceBlend.MOUTH_SMILE_RIGHT],
	"fun": [FaceBlend.MOUTH_SMILE_LEFT, FaceBlend.MOUTH_SMILE_RIGHT,
			FaceBlend.EYE_SQUINT_LEFT, FaceBlend.EYE_SQUINT_RIGHT],
	"sorrow": [FaceBlend.MOUTH_FROWN_LEFT, FaceBlend.MOUTH_FROWN_RIGHT],
	"sad": [FaceBlend.MOUTH_FROWN_LEFT, FaceBlend.MOUTH_FROWN_RIGHT],
	"angry": [FaceBlend.BROW_DOWN_LEFT, FaceBlend.BROW_DOWN_RIGHT,
			FaceBlend.MOUTH_PRESS_LEFT, FaceBlend.MOUTH_PRESS_RIGHT],
	"surprised": [FaceBlend.EYE_WIDE_LEFT, FaceBlend.EYE_WIDE_RIGHT,
			FaceBlend.BROW_OUTER_UP_LEFT, FaceBlend.BROW_OUTER_UP_RIGHT,
			FaceBlend.JAW_OPEN],
	"surprise": [FaceBlend.EYE_WIDE_LEFT, FaceBlend.EYE_WIDE_RIGHT,
			FaceBlend.BROW_OUTER_UP_LEFT, FaceBlend.BROW_OUTER_UP_RIGHT,
			FaceBlend.JAW_OPEN],
}
